...
var ASM_CONSTS = {
  88302: () => { if (document.fullscreenElement) return 1; },  
 88348: () => { return Module.canvas.width; },  
 88380: () => { return parseInt(Module.canvas.style.width); },  
 88428: () => { document.exitFullscreen(); },  
 88455: () => { setTimeout(function(){ Module.requestFullscreen(false, false); }, 100); },  
 88527: () => { if (document.fullscreenElement) return 1; },  
 88573: () => { return Module.canvas.width; },  
 88605: () => { return screen.width; },  
 88630: () => { document.exitFullscreen(); },  
 88657: ($0) => { const canvasId = UTF8ToString($0); setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { document.querySelector(canvasId).style.width="unset"; }, 100); }, 100); },  
 88851: () => { return window.innerWidth; },  
 88877: () => { return window.innerHeight; },  
 88904: () => { if (document.fullscreenElement) return 1; },  
 88950: () => { return Module.canvas.width; },  
 88982: () => { return parseInt(Module.canvas.style.width); },  
 89030: () => { if (document.fullscreenElement) return 1; },  
 89076: () => { return Module.canvas.width; },  
 89108: () => { return screen.width; },  
 89133: () => { return window.innerWidth; },  
 89159: () => { return window.innerHeight; },  
 89186: () => { if (document.fullscreenElement) return 1; },  
 89232: () => { return Module.canvas.width; },  
 89264: () => { return screen.width; },  
 89289: () => { document.exitFullscreen(); },  
 89316: () => { if (document.fullscreenElement) return 1; },  
 89362: () => { return Module.canvas.width; },  
 89394: () => { return parseInt(Module.canvas.style.width); },  
 89442: () => { document.exitFullscreen(); },  
 89469: ($0) => { Module.canvas.style.opacity = $0; },  
 89507: () => { return screen.width; },  
 89532: () => { return screen.height; },  
 89558: () => { return window.screenX; },  
 89585: () => { return window.screenY; },  
 89612: () => { return window.devicePixelRatio; },  
 89648: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 89701: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 89752: () => { Module.canvas.style.cursor = 'none'; },  
 89789: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 90045: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 90096: () => { if (document.pointerLockElement) return 1; },  
 90143: () => { if (document.fullscreenElement) return 1; },  
 90189: () => { return window.innerWidth; },  
 90215: () => { return window.innerHeight; }
};
